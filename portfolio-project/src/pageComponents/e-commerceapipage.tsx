      ...
      <div className="bg-black text-white min-h-screen flex flex-col px-6 md:px-12 py-28">
        <div className="flex flex-col md:flex-row">
          <div className="md:w-1/2 md:pr-12 space-y-6 md:sticky md:top-12 self-start">
            ...
            >
             ready-to-use Ecommerce api with docker, redis, and mongodb initialization setup.
            </motion.p>

            <div className="flex flex-wrap gap-3">
              {["NestJs", "Redis", "Docker", "MongoDb", "Paystack Integration", "swagger-ui"].map(
                (tech) => (
                  <span
                    key={tech}
                    className="
            ...
            >
              ...
              <p className="text-gray-400 leading-relaxed text-sm md:text-base">
                Reusable NestJS backend starter for storefronts, admin dashboards, marketplace prototypes, and e-commerce integrations. It ships with authentication, role-based access control, product catalog APIs, cart flows, orders, mock checkout, MongoDB persistence, Redis-backed caching, Swagger docs, and a seed script so a fresh clone is usable quickly.
              </p>

              <div className="flex space-x-4 pt-4">
                <a
                  href="https://github.com/iyanu752/e-commerce-api-template"
                  target="_blank"
