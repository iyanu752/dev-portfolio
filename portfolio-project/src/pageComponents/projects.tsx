  ...
  const projects = [
    {
      ...
      description:
        "Nigerian proptech platform for verified real estate listings.",
    ...
    },
    {
      ...
      description:
        "Ready to use e-commerce API with redis, docker, paystack integration template and mongodb setup.",
      categories: ["API"],
      useImage: false,
    },
    {
      ...
      description:
        "AI-powered VS Code extension for intelligent code suggestions.",
                  ...
                  <div className="absolute inset-0 flex flex-col justify-between p-6 md:p-8 pointer-events-none">
                    ...
                    >
                      ...
                      <div className="relative space-y-3">
                        <h3
                          className="text-3xl md:text-4xl lg:text-5xl font-bold tracking-tight drop-shadow-2xl"
                          style={{
                            textShadow:
                              "0 4px 20px rgba(0,0,0,0.9), 0 0 40px rgba(0,0,0,0.5)",
                          }}
                        >
                          {project.title}
                        </h3>
                        <p
                          className="text-gray-200 text-sm md:text-base max-w-md drop-shadow-lg opacity-90 group-hover:opacity-100 transition-opacity duration-300"
